...
<head>
  ...
  <!-- Title -->
  <title>Playlist | SoundWave</title>
...
<body>
  ...
  <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/2.jpg);">
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-12">
          <h2 class="title mt-70">Playlist</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- ***** Breadcrumb Area End ***** -->
<?php
    $p = select("SELECT * FROM `audio` INNER JOIN playlist on audio.id=playlist.audioid WHERE playlist.userid='" . $_SESSION['userlogin'] . "' ");
          ...
          <div class="col-12">
            <div class="poca-music-area box-shadow d-flex align-items-center flex-wrap border" data-animation="fadeInUp" data-delay="900ms">
              ...
              <div class="poca-music-content">
                ...
                <a href="des.php?id=<?= $r[0] ?>">
                  <h2><?= $title ?></h2>
                </a>
                <div class="music-meta-data">
                  <p>By <a href="#" class="music-author"></a>Admin <a href="#" class="music-catagory"></a></p>
                </div>
                <!-- Music Player -->
                ...
                <div class="likes-share-download d-flex align-items-center justify-content-between">
                  ...
                  <div>
                    <a href="deleteplaylist.php?id=<?= $r[0] ?>"><i class="fa fa-download" aria-hidden="true"></i> Delete</a>
                  </div>
                  <div>
